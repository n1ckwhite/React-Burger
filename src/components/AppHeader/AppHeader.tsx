      ...
      <nav className={`${stylesHeader.nav}  pb-4 pt-4`}>
        <ul className={`${stylesHeader.ul}`}>
          <li className={`${stylesHeader.li}`}>
            <NavLink
              to="/"
              onClick={() => setClassLink("constructor")}
              className={`${stylesHeader.button} ${
                classLink === "constructor" ? stylesHeader.button_active : ""
              }  pt-4 pb-4 pl-5 pr-5`}
            >
              <BurgerIcon
                type={classLink === "constructor" ? "primary" : "secondary"}
              />
            ...
            >
              <ListIcon
                type={classLink === "lenta" ? "primary" : "secondary"}
              />
          ...
          <li className={`${stylesHeader.li}`}>
            <NavLink
              to="/profile"
              onClick={() => setClassLink("profile")}
              className={`${stylesHeader.button} ${
                classLink === "/profile" ? stylesHeader.button_active : ""
              } pt-4 pb-4 pl-5 pr-5`}
            >
              <ProfileIcon
                type={classLink === "/profile" ? "primary" : "secondary"}
              />
